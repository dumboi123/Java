...
public class DangKyThanhVienForm extends javax.swing.JFrame {
    ...
    private void btnDangKyTvActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDangKyTvActionPerformed
        try {
            if (!lblMaTv.getText().isEmpty() && !txtMk.getText().isEmpty() && !txtTenTv.getText().isEmpty() && !dPNgaySinh.getText().isEmpty() && !txtSdtTV.getText().isEmpty() && !txtEmailTv.getText().isEmpty()) {
                if (Help.Sys.NameChecker.check_Name(txtTenTv.getText())) {
                    if (Help.Sys.check_sdt(txtSdtTV.getText())) {
                        if (Help.Sys.check_gmail2(txtEmailTv.getText())) {
                            String[] str = {
