...
public class ManageForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbxCategory.getAccessibleContext().setAccessibleName("Loại món");
        cbxCategory.getAccessibleContext().setAccessibleDescription("");
    ...
    private void mnAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnAdminActionPerformed
        if(ma_quyen == 1){
            ...
            JOptionPane.showMessageDialog(this,"Bạn Không Đủ Quyền Truy Cập!! ","Lỗi Truy Cập", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void btnXoaMonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaMonActionPerformed
        ...
        if(click >= 0){
            ...
            int soluong = (int)tblInfobill.getValueAt(click, 3);
            int gia_giam = Integer.parseInt(lblGiam.getText());
            lblTotalPrice.setText(String.valueOf((totalPrice-giaSpXoa*soluong)));
            String totalPriceAfter = totalPrice - gia_giam < 0 ? "0" : String.valueOf(totalPrice - gia_giam);
            lblTotalPriceAfter.setText(totalPriceAfter);
...
//                        System.out.println(phieuGiamGiaDTO);
    ...
    private void btnThanhToanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThanhToanActionPerformed
        ...
        if(kq ==0){
            ...
            int tong_tien = Integer.parseInt(hd[3]);
            if(hd[2] != null){
                if(tong_tien > 10000){
                    ThanhVienBLL tvbll = new ThanhVienBLL();
                    int currentPoint =  tvbll.getPointFromID(hd[2]);
                    currentPoint +=tong_tien*0.1 - Integer.parseInt(hd[4]);
