...
//        load();
    ...
    private void initTableMonAn() {
        ...
        String[] title = {"Mã SP", "Tên SP", "Số lượng", "Giá", "Giá giảm", "Giá hiện tại", "Danh mục"};
    ...
    private void initTableLMA() {
        ...
        String[] title = {"Mã loại sản phẩm", "Tên loại sản phẩm"};
    ...
    private void loadComboboxSearchDN() {
        ...
        cbxSearchDH.addItem("Mã SP");
        cbxSearchDH.addItem("Tên SP");
    }

    private void initTableFood() {
        modelFood = new DefaultTableModel();
        String[] title = {"Mã SP", "Tên SP", "Giá"};
    ...
    private void initTableCTDonNhap() {
        ...
        String[] title = {"Mã SP", "Tên SP", "Giá", "Số lượng", "Thành tiền"};
    ...
    public void setInitTable() {
        ...
        modelPGG.setColumnIdentifiers(new String[]{
            "Mã phiếu giảm", "Tên", "Giảm", "Ngày bắt đầu", "Ngày kết thúc", "Trạng thái"
        });
    ...
    private void initComponents() {
        ...
        btnNewNCC2 = new javax.swing.JButton();
        ...
        txtSearchHDGiaTu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtSearchHDGiaTuActionPerformed(evt);
            }
        });
        ...
        txtSearchDNTongTienTU.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtSearchDNTongTienTUActionPerformed(evt);
            }
        });
        ...
        jLabel11.setText("DANH SÁCH LOẠI SP");
        ...
        txtSearchLM.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtSearchLMActionPerformed(evt);
            }
        });
        ...
        txtTenMon.setBorder(javax.swing.BorderFactory.createTitledBorder("Tên SP"));
        ...
        cbbLoaiMon.setBorder(javax.swing.BorderFactory.createTitledBorder("Danh mục loại sp"));
        ...
        lblMaMon.setBorder(javax.swing.BorderFactory.createTitledBorder("Mã SP"));
        ...
        cbbTkNv.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbbTkNvActionPerformed(evt);
            }
        });
        ...
        cbxCategory.setBorder(javax.swing.BorderFactory.createTitledBorder("Loại SP"));
        ...
        jPanel36Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel36Layout.createSequentialGroup()
                ...
                .addGroup(jPanel36Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(cbxSearchDH, javax.swing.GroupLayout.Alignment.LEADING, 0, 129, Short.MAX_VALUE)
        ...
        btnNewNCC2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8-key-2-30.png"))); // NOI18N
        btnNewNCC2.setText("Tạo mới");
        btnNewNCC2.setBackground(new java.awt.Color(153, 153, 255));
        btnNewNCC2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnNewNCC2.setForeground(new java.awt.Color(255, 255, 255));
        btnNewNCC2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnNewNCC2ActionPerformed(evt);
            }
        });
        ...
        cbxSearchNCC.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbxSearchNCCActionPerformed(evt);
            }
        });
        ...
        jPanel43Layout.setVerticalGroup(
            ...
            .addGroup(jPanel43Layout.createSequentialGroup()
                ...
                .addGroup(jPanel43Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnNewNCC2, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel43Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnloadNCC, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btnDelTkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelTkActionPerformed
        if (!lblMaTk.getText().isEmpty() && !txtTenTK.getText().isEmpty() && !txtMk.getText().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Chon Du Lieu Can Xoa", "Loi", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void btnAddTKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddTKActionPerformed
        if (!lblMaTk.getText().isEmpty() && !txtTenTK.getText().isEmpty() && !txtMk.getText().isEmpty()) {
            ...
            if (taiKhoanBLL.checkDuplicateUsername(str[1]) == true) {
                JOptionPane.showMessageDialog(this,"Tai khoan bi trung" , "Thong Bao", JOptionPane.ERROR_MESSAGE); 
            }else{
    ...
    private void btnDelMAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelMAActionPerformed
        if (!lblMaMon.getText().isEmpty() && !txtTenMon.getText().isEmpty() && !lblSoLuong.getText().isEmpty() && !txtGia.getText().isEmpty()) {
            int kq = JOptionPane.showConfirmDialog(this, xoa, thongBao, JOptionPane.YES_OPTION);
            if (kq == 0) {
    ...
    private void btnUpdateMAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateMAActionPerformed
        if (!lblMaMon.getText().isEmpty() && !txtTenMon.getText().isEmpty() && !lblSoLuong.getText().isEmpty() && !txtGia.getText().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Chon Du Lieu Can Sua", "Loi", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void btnDelLMAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelLMAActionPerformed
        if (!lblMaLoai.getText().isEmpty() && !txtTenLoai.getText().isEmpty()) {
            int kq = JOptionPane.showConfirmDialog(this, xoa, thongBao, JOptionPane.YES_OPTION);
            if (kq == 0) {
    ...
    private void btnUpdateLMAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateLMAActionPerformed
        if (!txtTenLoai.getText().isEmpty() && !lblMaLoai.getText().isEmpty()) {
            String[] str = {
    ...
    private void btnSuaCTKMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaCTKMActionPerformed
        if (!lblMaKM.getText().isEmpty() && !txtTenCTKM.getText().isEmpty()) {
            String[] str = {
                lblMaKM.getText(),
                txtTenCTKM.getText(),
            ...
            JOptionPane.showMessageDialog(this, "Chua chon du lieu can Sua", "Loi", JOptionPane.ERROR_MESSAGE);
        }
...
//                    System.out.println(soLuongConLai);
    ...
    private void btnXoaNVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaNVActionPerformed
        if (!lblMaNV.getText().isEmpty() && !txtTenNV.getText().isEmpty() && !dPNgaySinhNV.getText().isEmpty() && !txtSdt.getText().isEmpty() && !txtMail.getText().isEmpty()) {
            int kq = JOptionPane.showConfirmDialog(this, xoa, thongBao, JOptionPane.YES_OPTION);
            if (kq == 0) {
    ...
    private void btnDelNCCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelNCCActionPerformed
        if (!lblMaNCC.getText().isEmpty() && !txtTenNCC.getText().isEmpty() && !txtDiaChi.getText().isEmpty()) {
            int kq = JOptionPane.showConfirmDialog(this, xoa, thongBao, JOptionPane.YES_OPTION);
            if (kq == 0) {
    ...
    private void btnSuaCTKM1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaCTKM1ActionPerformed
        if (!lblMaPGG.getText().isEmpty() && !txtTenPGG.getText().isEmpty() && !txtGiamTien.getText().isEmpty() && !dpNgayPGGbd.getDate().toString().isEmpty() && !dpNgayPGGkt.getDate().toString().isEmpty()) {
            String[] str = {
                lblMaPGG.getText(),
                txtTenPGG.getText(),
                txtGiamTien.getText(),
    ...
    private void btnThemCTKM1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemCTKM1ActionPerformed
        if (!lblMaPGG.getText().isEmpty() && !txtTenPGG.getText().isEmpty() && !txtGiamTien.getText().isEmpty() && !dpNgayPGGbd.getText().isEmpty() && !dpNgayPGGkt.getText().isEmpty()) {
            String[] str = {
                lblMaPGG.getText(),
                txtTenPGG.getText(),
                txtGiamTien.getText(),
    ...
    private void btnDelTVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelTVActionPerformed
        if (!lblMaTV.getText().isEmpty() && !txtTenTv.getText().isEmpty() && !txtMkTv.getText().isEmpty() && !dPNgaySinhTV.getDate().toString().isEmpty() && !txtSdtTV.getText().isEmpty() && !txtMailTV.getText().isEmpty()) {
            int kq = JOptionPane.showConfirmDialog(this, xoa, thongBao, JOptionPane.YES_OPTION);
            if (kq == 0) {
...
//            Logger.getLogger(AdminForm.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btnNewNCCActionPerformed(java.awt.event.ActionEvent evt) {
        setNullNCC();
        lblMaNCC.setText("NCC" + nhaCungCapBLL.maMoi());
    }

//Nut Tạo Moi
    private void btnNewNCC2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewNCC2ActionPerformed
        setNullNCC();
        lblMaNCC.setText("NCC" + nhaCungCapBLL.maMoi());
    }//GEN-LAST:event_btnNewNCC2ActionPerformed
    ...
    private void cbxSearchNCCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxSearchNCCActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbxSearchNCCActionPerformed

    private void txtSearchLMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSearchLMActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtSearchLMActionPerformed
    ...
    private void cbbTkNvActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbbTkNvActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbbTkNvActionPerformed

    private void txtSearchDNTongTienTUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSearchDNTongTienTUActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtSearchDNTongTienTUActionPerformed

    private void txtSearchHDGiaTuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSearchHDGiaTuActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtSearchHDGiaTuActionPerformed
...
//</editor-fold>
    ...
    private javax.swing.JButton btnNewNCC2;
