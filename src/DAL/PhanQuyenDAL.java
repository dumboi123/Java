...
public class PhanQuyenDAL {
    ...
    public List<PhanQuyenDTO> getData(){
        ...
        try {
            String query = "SELECT * FROM `phan_quyen` WHERE `trang_thai` = 1 ORDER BY `ma_quyen` ASC";
    ...
    public void addData(String []arr){
        try {
            String query = "INSERT INTO `phan_quyen`(`ma_quyen`, `quyen`,`trang_thai`) "
                + "VALUES ("+Integer.parseInt(arr[0])+",'"+arr[1]+"',1)";
    ...
    public void delData(int ma_quyen){
        try {
            String query = "Update `phan_quyen` Set `trang_thai` = 0 Where `ma_quyen` = '"+ma_quyen+"'";
    ...
    public void updateData(String []arr){
        try {
            String query = "UPDATE `phan_quyen` "
                ...
                + "WHERE `trang_thai` = 1 and `ma_quyen` = "+Integer.parseInt(arr[0]);
//            dataProvider.getStatement();
            dataProvider.ExecuteUpdate(query);
            dataProvider.closeConnect();
        } catch (Exception e) {
